    ...
    public void start() {
        ...
        context.addEventListener(new ServletContextListener() {
            ...
            public void contextInitialized(final ServletContextEvent servletContextEvent) {
                ...
                servletContext.addFilter("security", new LoginFilter(new PersistentSessionRepository(new ConnectionProvider("jdbc:postgresql://localhost/bank", "postgres", "clouway.com"), new Timeout(1)), new Timeout(1))).addMappingForUrlPatterns(EnumSet.of(DispatcherType.REQUEST), true, "/*");
            }
