  ...
  public void start() {
    ...
    context.addEventListener(new ServletContextListener() {
      ...
      public void contextInitialized(final ServletContextEvent servletContextEvent) {
        ...
        servletContext.addFilter("loginFilter", new LoginFilter(new PersistentSessionRepository((new ConnectionProvider("jdbc:postgresql://localhost/bank", "postgres", "clouway.com")), new Timeout(5)), new Timeout(5))).addMappingForUrlPatterns(EnumSet.of(DispatcherType.REQUEST), true, "/login");
        ...
        servletContext.addServlet("loginController", new LoginControllerServlet(new PersistentUserRepository(new ConnectionProvider("jdbc:postgresql://localhost/bank", "postgres", "clouway.com")), new PersistentSessionRepository(new ConnectionProvider("jdbc:postgresql://localhost/bank", "postgres", "clouway.com"), new Timeout(10)), new UserValidator(), new Timeout(1), new IdsGenerator())).addMapping("/loginController");
