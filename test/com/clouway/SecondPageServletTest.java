 ...
 */
public class SecondPageServletTest {
  @Rule
  ...
  public void happyPath() throws Exception {
    SecondPageServlet secondPage = new SecondPageServlet();
    ...
    secondPage.doGet(request, response);

    String actual = out.toString();

    assertThat(actual, containsString("<div>WELCOME!!!</div>This is second page!<br>"));
  }
